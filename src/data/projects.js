...
const projects = [
  {
    ...
    description:
      "Tienda web Full Stack en producción con dominio propio y clientes reales. API REST en Django con autenticación JWT, frontend en React y PostgreSQL, todo orquestado con Docker Compose. Desplegada en un VPS Linux con Nginx y Gunicorn, HTTPS mediante Let's Encrypt con renovación automática y copias de seguridad diarias enviadas fuera del servidor.",
    technologies: [
      "React",
      "Vite",
      "Django REST",
